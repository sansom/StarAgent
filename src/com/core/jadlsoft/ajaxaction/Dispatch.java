...
package com.core.jadlsoft.ajaxaction;
...
import com.core.jadlsoft.dbutils.BlobUtils;
...
public class Dispatch extends HttpServlet {
	...
	private void returnSimpleErrorResult(String errinfo, HttpServletResponse response) throws IOException {
		...
		if (errinfo == null || errinfo.length() == 0) {
			result = "<?xml version=\"1.0\" encoding=\"utf-8\"?><result><status>1</status><content></content></result>";
		} else {
			result = "<?xml version=\"1.0\" encoding=\"utf-8\"?><result><status>1</status><content>" + errinfo + "</content></result>";
		}
		returnResult(response, result);
	}
	...
	private void checkDataExist(HttpServletRequest request, HttpServletResponse response) throws IOException {
		try {
			String result = "<?xml version=\"1.0\" encoding=\"utf-8\"?><result><status>0</status><content></content></result>";
