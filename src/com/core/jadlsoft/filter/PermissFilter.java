...
public class PermissFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
    	...
    	//以下进行权限控制
		if(!isAccessable((HttpServletRequest)request, (UserSessionBean)session.getAttribute(UserUtils.USER_SESSION))) {
     ...
     * 2006-10-19
     */
    private boolean isAccessable(HttpServletRequest request, UserSessionBean user) {
    	//获取URL
