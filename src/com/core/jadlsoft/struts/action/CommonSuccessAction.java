...
import com.core.jadlsoft.business.xtgl.AopManager;
import com.core.jadlsoft.dbutils.DicMapUtils;
import com.core.jadlsoft.struts.interceptor.CommonSuccessInterceptor;
import com.core.jadlsoft.utils.DomainBeanUtils;
		...
		if (bean != null) {
			...
			if ((gncode != null) && (!"".equals(gncode.toString()))) {
				...
				if (data == null) {
					...
					aopManager.saveXtrz(getUserSessionBean(), (String)gncode, sm);
				}
