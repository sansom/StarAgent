...
package com.core.jadlsoft.struts.action.search;
...
import com.core.jadlsoft.business.search.SearchManager;
import com.core.jadlsoft.model.search.SearchBean;
...
//					(String)itemmap.get("forward"): SystemConstants.SUCCESS_KEY);
			...
			String returnStr = itemmap.containsKey("forward") ? (String)itemmap.get("forward"): multiselect;
			return returnStr;
		}
