...
<body >
	<c:set var="gzlx" value="<%=SystemConstants.GZZX_GZLX_YY %>"></c:set>
	<%@ include file="gzzx.inc"%>
	
	<form action="../gzzx/yygzzxlist.action" id="gzzxForm" name="gzzxForm" method="post">
		...
		<input type="hidden" id="gzlx" name="gzzxJbxxBean.gzlx" title="故障类型" value="<%=SystemConstants.GZZX_GZLX_YY %>" />
	</form>
</body>
</html>