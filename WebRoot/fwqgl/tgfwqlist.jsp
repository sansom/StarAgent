...
<form action="../fwqgl/tgfwqlist.action" id="fwqForm" name="fwqForm" method="post">
	...
	<input type="hidden" id="ptlx" name="fwqBean.ptlx" title="平台类型" value="<%=SystemConstants.PTLX_TG %>" />
